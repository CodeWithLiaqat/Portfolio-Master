...
export const insights = [
  {
    ...
    content: 'Lorem ipsum dolor sit amet. Write real content. A portfolio without a perspective is just a list of links. Founders want to see your brain, not just your hands. They look for intent, typography that breathes, and a lack of generic templates.',
    date: '2026-02-14'
  },
  {
    ...
    content: 'Templates save time on day one and cost time every day after. You are fitting your unique business logic into someone else\'s generic container. Build bespoke from the ground up to ensure your technical foundation mirrors your actual operations.',
    date: '2026-01-28'
  },
  {
    ...
    content: 'Performance is a design feature. We use demand-based frameloops in WebGL, strictly manage our texture sizes, and leverage CSS for anything that doesn\'t strictly need the GPU. You can have your cinematic cake and load it too.',
    date: '2025-11-04'
  },
  {
    ...
    content: 'AI writes code, but it does not have taste. The developer of the future is an editor and an art director. The baseline of quality will rise, meaning true differentiation will come from extreme craft, esoteric ideas, and human intent.',
    date: '2025-10-12'
  }
];
